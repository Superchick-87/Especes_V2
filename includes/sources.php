<?php
echo '<legend class="fondSource margeTop">
Ce projet a été initié par la rédaction de Sud Ouest (Medialab) sur une idée de Natacha Thuillier, en collaboration avec les équipes de l\'Observatoire de la faune sauvage de Nouvelle-Aquitaine (<a href="https://observatoire-fauna.fr" target="_blank">https://observatoire-fauna.fr</a>).
<br><hr>
L’Observatoire FAUNA est un pôle de gestion de données et d’expertises collaboratives sur la faune sauvage de Nouvelle-Aquitaine. Celui-ci recense les espèces à partir d’observations des scientifiques et des partenaires naturalistes de la région.
<br><hr>
Les données d\'observations des espèces mentionnées pour chaque commune correspondent aux recensements effectués depuis le 1er janvier 2000 dans un rayon de 5 kilomètres autour de chaque commune. L\'absence d\'observations pour une espèce ne signifie pas nécessairement qu\'elle n\'est pas présente sur ce territoire.
<br><hr>
Toutes les photographies sous licence libre des espèces proviennent de l\'Inventaire national du patrimoine naturel via l\'API Taxref du Muséum national d\'histoire naturel (<a href="https://taxref.mnhn.fr/taxref-web/accueil" target="_blank">https://taxref.mnhn.fr/taxref-web/accueil</a>).
<br><hr>
Un prototype de ce projet a été réalisé en janvier 2023 à Nantes dans le cadre du hackathon Hyblab (<a href="https://apps.hyblab.fr/nantes2023/herisson/" target="_blank">https://apps.hyblab.fr/nantes2023/herisson/</a>). Y ont contribué des étudiants des écoles EPJT, AGR et Polytech.
<br><hr>
